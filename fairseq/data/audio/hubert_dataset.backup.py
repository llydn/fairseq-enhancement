...
class HubertDataset(FairseqDataset):
    def __init__(
        ...
        source_enh: bool = False,
        enh_models: Optional[str] = None, # path for JSON {'model_name': 'path'}
    ):
        ...
        # self.source_enh = source_enh
        # self.enh_name2meta_info = {}
        # if self.source_enh:
        #     with open(enh_models, "r") as f:
        #         obj = json.load(f)
        ...
        # # for name in ['ConvTasNet', 'DCCRNet', 'DCUNet', 'DPRNNTasNet', 'DPTNet']:
