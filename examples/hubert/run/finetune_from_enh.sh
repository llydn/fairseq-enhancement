...
init_dir=/mnt/lustre/sjtu/home/ww089/fairseqs/fairseq-dny/egs/sec/exp/hubert_base_librispeech_enhfromlibrimix_train_ls_960_enh_label_km_L9_500
checkpoint_name=checkpoint_16_42950.pt
...
if [ -z "${hubert_tag}" ]; then
    hubert_tag=${config_name}_finetune_$(basename "${data}")_from_enhfromlibrimix_${checkpoint_base_name}
fi
