...
test_sets="ls_test_clean_wham_0_5db ls_test_clean_wham_5_10db ls_test_other_wham_0_5db ls_test_other_wham_5_10db"
device=0
enh_models="DCCRNet DCUNet DPTNet DPRNNTasNet ConvTasNet"
