...
function do_filtering {
  ...
  [ -f $srcdir/reco2dur ] && utils/filter_scp.pl $destdir/utt2spk <$srcdir/reco2dur >$destdir/reco2dur
  ...
  [ -f $srcdir/utt2cat ] && utils/filter_scp.pl $destdir/utt2spk <$srcdir/utt2cat >$destdir/utt2cat
  [ -f $srcdir/wav.scp ] && utils/filter_scp.pl $destdir/utt2spk <$srcdir/wav.scp >$destdir/wav.scp
  [ -f $srcdir/spk1.scp ] && utils/filter_scp.pl $destdir/utt2spk <$srcdir/spk1.scp >$destdir/spk1.scp
  [ -f $srcdir/utt2num_samples ] && utils/filter_scp.pl $destdir/utt2spk <$srcdir/utt2num_samples >$destdir/utt2num_samples
  [ -f $srcdir/ali ] && utils/filter_scp.pl $destdir/utt2spk <$srcdir/ali >$destdir/ali
  ...
  [ -f $srcdir/text_phn ] && utils/filter_scp.pl $destdir/utt2spk <$srcdir/text_phn >$destdir/text_phn
